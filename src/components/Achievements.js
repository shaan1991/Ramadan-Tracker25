...
const Achievements = () => {
  ...
  useEffect(() => {
    ...
    const loadAchievements = async () => {
      ...
      setGeneralBadges(general);
      setRamadanBadges(ramadan);
    };
  ...
  return (
    <div className="achievements-container">
      ...
      {showAll && (
        <div className="achievements-modal-overlay" onClick={() => setShowAll(false)}>
          <div className="achievements-modal" onClick={(e) => e.stopPropagation()}>
            <div className="achievements-modal-header">
              <h4>All Achievements</h4>
              <button className="achievements-modal-close" onClick={() => setShowAll(false)}>
                ✕
              </button>
            </div>
